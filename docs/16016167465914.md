...
![](https://user-gold-cdn.xitu.io/2019/5/2/16a777b69ca173bc)
...
![](https://user-gold-cdn.xitu.io/2019/5/2/16a777b69c35eca1)

![](https://user-gold-cdn.xitu.io/2019/5/2/16a777b69fad4b55)
...
![](https://user-gold-cdn.xitu.io/2019/5/2/16a777b6861699be?imageView2/0/w/1280/h/960/ignore-error/1)

对于播放回调,当你的音频播放队列需要播放一个音频数据时它将被调用.你的回调函数将从磁盘读取指定数量的音频数据包然后将它们封装在audio queue对象的buffer中.audio queue将按顺序播放这些buffer. 

![](https://user-gold-cdn.xitu.io/2019/5/2/16a777b683b98c61?imageView2/0/w/1280/h/960/ignore-error/1)
