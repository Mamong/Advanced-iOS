# CoreText使用教程(四)
http://www.zoomfeng.com/blog/coretext-4.html
...
省略号放到最后一个字符
![](http://www.zoomfeng.com/images/2015/05/30/CoreText_1.png)

省略号放置在最后一行约1/3行处
![](http://www.zoomfeng.com/images/2015/05/30/CoreText_2.png)
