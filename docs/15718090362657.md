#CoreText使用教程(二)
http://www.zoomfeng.com/blog/coretext-2.html
...
网络图片还未下载完成时的效果：
![](http://www.zoomfeng.com/images/2015/05/21/CoreText_1.png)

网络图片已下载完成时的效果：
![](http://www.zoomfeng.com/images/2015/05/21/CoreText_2.png)
