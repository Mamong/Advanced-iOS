...
![](https://user-gold-cdn.xitu.io/2019/4/14/16a1bfe17a666fa3?imageView2/0/w/1280/h/960/ignore-error/1)
...
![](https://user-gold-cdn.xitu.io/2019/4/14/16a1bfe183c52255?imageView2/0/w/1280/h/960/ignore-error/1)
![](https://user-gold-cdn.xitu.io/2019/4/14/16a1bfe1793cd6bd?imageView2/0/w/1280/h/960/ignore-error/1)
...
```
* 播放结束
注册AVPlayerItemDidPlayToEndTimeNotification当播放结束
```
...
![](https://user-gold-cdn.xitu.io/2019/4/14/16a1bfe1aeaed2e7?imageView2/0/w/1280/h/960/ignore-error/1)

使用AVMutableAudioMix类,可以执行自定义的音频处理. 
![](https://user-gold-cdn.xitu.io/2019/4/14/16a1bfe1aae7e647?imageView2/0/w/1280/h/960/ignore-error/1)

AVMutableVideoComposition: 使用合成的track进行编辑 AVMutableVideoCompositionLayerInstruction: 变换,渐变变换,不透明度,渐变不透明 
![](https://user-gold-cdn.xitu.io/2019/4/14/16a1bfe1b7880e50?imageView2/0/w/1280/h/960/ignore-error/1)

AVAssetExportSession: 将音视频合成 
![](https://user-gold-cdn.xitu.io/2019/4/14/16a1bfe268d48510?imageView2/0/w/1280/h/960/ignore-error/1)
...
使用AVMutableComposition将多个asset组合在一起
```
AVMutableComposition *mutableComposition = [AVMutableComposition composition];
...
为了让asset writer能够写入数据,必须键值至少一个asset writer输入源.
```
...
作者：小东邪
链接：https://juejin.im/post/6844903821278183438
来源：掘金
